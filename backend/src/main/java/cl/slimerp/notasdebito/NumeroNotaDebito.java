...
// Única fuente de verdad del número visible de una nota de débito: el folio es
...
public final class NumeroNotaDebito {

    private static final String PREFIJO = "ND-";

    private NumeroNotaDebito() {
    }
    ...
    // Interpreta una búsqueda libre como folio: acepta "ND-000012", "nd-12" o
