...
export class GastosListaComponent implements OnInit, OnDestroy {
  @ViewChild('fg') formularioGasto?: NgForm;

  columnas = ['fecha', 'categoria', 'descripcion', 'monto', 'acciones'];
  ...
  // Un gasto está gestionado en Tesorería cuando existe su cuenta por pagar y
  // esta no está anulada. En ese estado no se puede editar ni eliminar.
  gestionadoEnTesoreria(gasto: Gasto): boolean {
    return !!gasto.cuentaPorPagarEstado && gasto.cuentaPorPagarEstado !== 'ANULADO';
  }
